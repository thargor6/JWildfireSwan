...
class SynthFunc extends VariationShaderFunc2D {
    ...
    get params(): VariationParam[] {
        return [{ name: this.PARAM_A, type: VariationParamType.VP_FLOAT, initialValue: 1.00 },
            { name: this.PARAM_MODE, type: VariationParamType.VP_INT, initialValue: 3 },
            { name: this.PARAM_POWER, type: VariationParamType.VP_FLOAT, initialValue: -2.00 },
            { name: this.PARAM_MIX, type: VariationParamType.VP_FLOAT, initialValue: 1.00 },
            { name: this.PARAM_SMOOTH, type: VariationParamType.VP_INT, initialValue: 0 },

            { name: this.PARAM_B, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_B_TYPE, type: VariationParamType.VP_INT, initialValue: 0 },
            { name: this.PARAM_B_SKEW, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_B_FRQ, type: VariationParamType.VP_FLOAT, initialValue: 1.0 },
            { name: this.PARAM_B_PHS, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_B_LAYER, type: VariationParamType.VP_INT, initialValue: 0 },

            { name: this.PARAM_C, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_C_TYPE, type: VariationParamType.VP_INT, initialValue: 0 },
            { name: this.PARAM_C_SKEW, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_C_FRQ, type: VariationParamType.VP_FLOAT, initialValue: 1.0 },
            { name: this.PARAM_C_PHS, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_C_LAYER, type: VariationParamType.VP_INT, initialValue: 0 },

            { name: this.PARAM_D, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_D_TYPE, type: VariationParamType.VP_INT, initialValue: 0 },
            { name: this.PARAM_D_SKEW, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_D_FRQ, type: VariationParamType.VP_FLOAT, initialValue: 1.0 },
            { name: this.PARAM_D_PHS, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_D_LAYER, type: VariationParamType.VP_INT, initialValue: 0 },

            { name: this.PARAM_E, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_E_TYPE, type: VariationParamType.VP_INT, initialValue: 0 },
            { name: this.PARAM_E_SKEW, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_E_FRQ, type: VariationParamType.VP_FLOAT, initialValue: 1.0 },
            { name: this.PARAM_E_PHS, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_E_LAYER, type: VariationParamType.VP_INT, initialValue: 0 },

            { name: this.PARAM_F, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_F_TYPE, type: VariationParamType.VP_INT, initialValue: 0 },
            { name: this.PARAM_F_SKEW, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_F_FRQ, type: VariationParamType.VP_FLOAT, initialValue: 1.0 },
            { name: this.PARAM_F_PHS, type: VariationParamType.VP_FLOAT, initialValue: 0.0 },
            { name: this.PARAM_F_LAYER, type: VariationParamType.VP_INT, initialValue: 0 }
        ]
    }
